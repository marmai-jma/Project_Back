...
public class MediaLightDTO {
    ...
    public MediaLightDTO() {}


    public MediaLightDTO(String id, String label, Category category, Type type, String authorName, String authorSurname, String description, String mediaImageURL, LocalDate publicationDate, int likesTotalNumber, int dislikesTotalNumber) {
        this.id = id;
        this.label = label;
